...
print 'Param1 (Einstein radius) = {0:.3e}, Param2 (Ellipticity) = {1:.3e}, Param3 (Projection angle) = {2:.3e}'.format(param1,param2,param3) #prints values of optimised parameters
